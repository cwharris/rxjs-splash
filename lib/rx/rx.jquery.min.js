...
dataType:c,data:b})};f.getJSONAsObservable=function(a,b){return k({url:a,dataType:"json",data:b})};f.getScriptAsObservable=function(a){return k({url:a,dataType:"script"})};f.postAsObservable=function(a,b,c){return k({url:a,dataType:c,data:b,type:"POST"})}})(window,jQuery);